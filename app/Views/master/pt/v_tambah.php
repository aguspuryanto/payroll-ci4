      ...
      <div class="col-md-12">
        <form method="post">    
            ...
            <div class="col-sm-3">
              <select class="form-select select2"  name="kebun" id="kebun" autofocus>
                ...
                foreach($kebuns as $kebun) {
                  $selected = (set_value('kebun')==$kebun->id) ? "selected" : "";
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="nama" name="nama" maxlength="100"  required value="<?= set_value('nama'); ?>">
