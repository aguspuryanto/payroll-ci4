    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= site_url('bon/daftar?status=2'); ?>">Realisasi</a></li>
          <li class="breadcrumb-item active" aria-current="page">Tambah</li>
        </ol>
      </nav>
      <h1 class="h2">Tambah Realisasi</h1>        
    </div>
    ...
    <form method="post" enctype="multipart/form-data"> 
      <div class="row">
        <div class="col-md-6">
            ...
            <div class="row mb-3">
              <label for="bukti" class="col-sm-4 col-form-label">Upload File Bukti Realisasi</label>
              <div class="col-sm-7">
                <input type="file" class="form-control" id="bukti" name="bukti" accept="image/jpeg, image/png">
                <p class="text-muted fst-italic">.jpg/.png max 1 MB</p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
      ...
      <div class="row mb-3">
        <div class="col-md-12">
          <input type="checkbox" name="sudah" value="1" required id="sudah"> <label for="sudah">Data di atas sudah benar <span class='text-danger'>*</span></label>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
