<div class="row">
  <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <h1 class="h2">Tambah Departmen</h1>        
    </div>
      ...
      <div class="col-md-12">
        <form method="post">
            ...
            <div class="col-sm-3">
              <select class="form-select select2" required name="kode_pt" id="kode_pt" autofocus>
                ...
                foreach($pts as $pt) {
                  ...
                  $selected = (set_value('kode_pt')==$pt->kode_pt) ? "selected" : "";
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="nama" name="nama" maxlength="45" autofocus required value="<?= set_value('nama'); ?>">
