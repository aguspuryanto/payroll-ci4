<div class="row">
  <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= site_url('payroll/daftar'); ?>">Payroll</a></li>
          <li class="breadcrumb-item active" aria-current="page">PPh 21</li>
        </ol>
      </nav>
      <h1 class="h2">PPh 21</h1>        
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <form method="post" action="<?= base_url('payroll/pph21?kode='.$payroll->kode_payroll) ?>" >
        <div class="row mb-3">
          ...
          <div class="row mb-3">
            <div class="col-sm-12 text-end">
              <a href="#" class="btn btn-outline-primary upload " data-bs-toggle='modal' data-bs-target='#uploadModal'><i class="fa fa-file-csv"></i> Upload CSV</a>
            </div>
          </div>
          <div class="row mb-3">
              ...
              <table class="table table-hover table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th style="min-width: 100px;">PPh 21 <span class="text-danger">*</span></th>
                    <th style="min-width: 110px;">Gaji Pokok</th>
                    <th style="min-width: 120px;">Gaji Jabatan Tetap</th>
                ...
                <tbody class="body-payroll">
                  <tr>                    
                    ...
                    $total_total=0;
                    if(empty($detils)) {
                      echo "<td colspan='23' class='fst-italic'>Belum ada data</td>";
                    } else {
                      foreach($detils as $detil) {
                        ...
                        echo "<td class='text-end'><input type='text' tag='pph21' class='form-control number pph21 text-end' name='pph21[$detil->kode_payroll_detil]' kode='$detil->kode_payroll_detil' nik='$detil->nik_pt_karyawan' value='$detil->pph21'></td>";
                        echo "<td class='text-end'><span class='gaji_pokok' kode='$detil->kode_payroll_detil'>".number_format($detil->gaji_pokok,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='gaji_jabatan_tetap' kode='$detil->kode_payroll_detil'>".number_format($detil->gaji_jabatan_tetap,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='tunjangan' kode='$detil->kode_payroll_detil'>".number_format($detil->tunjangan,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='lembur' kode='$detil->kode_payroll_detil'>".number_format($detil->lembur,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='lainlain' kode='$detil->kode_payroll_detil'>".number_format($detil->lain_lain,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='thr' kode='$detil->kode_payroll_detil'>".number_format($detil->thr,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='gratifikasi' kode='$detil->kode_payroll_detil'>".number_format($detil->gratifikasi,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='rapel' kode='$detil->kode_payroll_detil'>".number_format($detil->rapel,0,".",",")."</span></td>";
                        ...
                        echo "<td class='text-end'><span class='bpjs_kes' kode='$detil->kode_payroll_detil'>".number_format($detil->bpjs_kes,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='bpjs_tk' kode='$detil->kode_payroll_detil'>".number_format($detil->bpjs_tk,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='pinjaman' kode='$detil->kode_payroll_detil'>".number_format($detil->pinjaman,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='nett' kode='$detil->kode_payroll_detil'>".number_format($detil->gaji_nett,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='bpjs_kes_pt' kode='$detil->kode_payroll_detil'>".number_format($detil->bpjs_kes_pt,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='bpjs_tk_jkm_pt' kode='$detil->kode_payroll_detil'>".number_format($detil->bpjs_tk_jkm_pt,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='bpjs_tk_jkk_pt' kode='$detil->kode_payroll_detil'>".number_format($detil->bpjs_tk_jkk_pt,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='bpjs_tk_jp_pt' kode='$detil->kode_payroll_detil'>".number_format($detil->bpjs_tk_jp_pt,0,".",",")."</span></td>";
                        echo "<td class='text-end'><span class='bpjs_tk_jht_pt' kode='$detil->kode_payroll_detil'>".number_format($detil->bpjs_tk_jht_pt,0,".",",")."</span></td>";
                        echo "</tr>";
                      }
                    }
                    ?>
