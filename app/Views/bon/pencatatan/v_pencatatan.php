...
<div class="row">
  <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Pencatatan Accounting</li>
        </ol>
      </nav>
      <h1 class="h2">Daftar Pencatatan Accounting</h1>
    ...
    <div class="row mb-3">
      ...
      <div class="row mb-3">
        <div class="col-md-12">
          <a class="btn btn-primary" href="<?= base_url('bon/daftar?status=0'); ?>">Tambah Pencatatan Accounting Baru</a>
        </div>
      </div>
    <div class="row">
      <div class="col-md-12">
        <div class="table-responsive">
          <table class="table table-hover table-striped table-bordered caption-top display nowrap" width="100%" id="datatable">
            <caption class="bg-dark text-light p-2">Pencatatan</caption>
            <thead>
              <tr>
                <th style="max-width: 70px !important;">Kode Bon</th>
                <th style="width: 100px !important;">Tanggal</th>
                <th style="width: 120px !important;">Karyawan</th>
                  ...
                  foreach($bons as $bon) {
                    echo "<tr>";
                      ...
                      echo "<td>
                        ...
                        <div>Pencatatan: ".($bon->tanggal_pencatatan ? date("Y-m-d", strtotime($bon->tanggal_pencatatan)) : "-")."</div>
