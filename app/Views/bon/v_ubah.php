<div class="row">
  <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
      <div class="col-md-12">
        <form method="post" action="<?= site_url("bon/daftar/ubah?kode=".$bon->kode_bon) ?>">
          <div class="row mb-3">
            ...
            <div class="col-sm-4">
              <select class="form-select select2" required name="karyawan" id="karyawan">
                ...
                foreach ($karyawans as $karyawan) {
                  $selected = $bon->kode_pt_karyawan == $karyawan->kode_pt_karyawan ? "selected" : "";
                  echo "<option value='".$karyawan->kode_pt_karyawan."' $selected>";
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-2">
              <div class="input-group">
                ...
                <input type="text" class="form-control number text-end" required id="nominal" name="nominal" value="<?= $bon->nominal; ?>">
              </div>
            </div>
          </div>
          <div class="row mb-3">
            ...
            <div class="col-sm-3">
              <textarea class="form-control" name="keterangan" id="keterangan"><?= $bon->keterangan; ?></textarea>
            </div>
          </div>
          <div class="row mb-3">
            ...
            <div class="col-sm-4">
              <select class="form-select select2" required name="kas" id="kas">
                ...
                <?php  
                foreach ($kass as $kas) {
                  $selected = $bon->kode_kas == $kas->kode_kas ? "selected" : "";
                  echo "<option value='".$kas->kode_kas."' $selected>";
                    echo  $kas->nama;
                  echo "</option>";
                }
                ?>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-4">
              <select class="form-select select2 pindah opsi" disabled required name="kas_tujuan" id="kas_tujuan">
                ...
                <?php  
                foreach ($kass as $kas) {
                  $selected = $bon->kode_kas_tujuan == $kas->kode_kas ? "selected" : "";
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-2">
              <div class="input-group">
                <input type="text" class="form-control number text-end pinjam opsi" <?php if($bon->jenis!="Pinjaman") echo "disabled"; ?> required id="cicilan" name="cicilan" value="<?= $bon->cicilan; ?>">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-3 mt-2">
              <input type="checkbox" class="keluar pinjam opsi " <?php if($bon->jenis=="Pemindahan Kas") echo "disabled"; ?> name="persetujuan" value="1" id="persetujuan" <?php if($bon->ispersetujuan) echo "checked"; ?>> &nbsp; <label for="persetujuan">Ya, butuh persetujuan Direksi</label>
            </div>
          </div>
          <input type="hidden" name="kode" value="<?= $bon->kode_bon; ?>">
